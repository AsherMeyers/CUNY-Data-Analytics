...
```{r}
mushroomdata <- read.csv(file = "https://archive.ics.uci.edu/ml/machine-learning-databases/mushroom/agaricus-lepiota.data", head=FALSE, sep=",")
```


#Store the list of column names
```{r}
mushroomcolnames<- c('edibility', 'cap-shape', 'cap-surface','cap-color', 'bruises', 'odor', 'gill-attachment', 'gill-spacing', 
...
#Replace shorthand of fourth column cap-colo                          
```{r}
